  ...
  return (
    <div className="min-h-screen py-12 px-4 flex flex-col items-center justify-center bg-background relative overflow-hidden">
      ...
      <button
        ...
        className="absolute top-6 left-6 md:top-10 md:left-10 text-muted-foreground hover:text-foreground flex items-center gap-2 transition-colors z-20 bg-surface/50 px-4 py-2 rounded-full border border-border backdrop-blur-sm"
      >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-foreground tracking-tight leading-tight drop-shadow-2xl">
            Desbloqueie seu <br />
        ...
        <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl items-stretch">
          ...
          <div className="bg-surface/40 backdrop-blur-xl border border-border p-8 rounded-[2rem] flex flex-col hover:border-primary/20 transition-all duration-300">
            <div className="mb-8">
              <h3 className="text-2xl font-bold text-foreground">Explorador</h3>
            ...
            <ul className="space-y-5 mb-10 flex-1">
              <li className="flex items-center gap-3 text-muted-foreground font-medium"><Check size={20} className="text-green-500 flex-shrink-0" /> 3 Missões por dia</li>
              <li className="flex items-center gap-3 text-muted-foreground font-medium"><Check size={20} className="text-green-500 flex-shrink-0" /> Acesso a trilhas básicas</li>
              <li className="flex items-center gap-3 text-muted-foreground font-medium"><Check size={20} className="text-green-500 flex-shrink-0" /> Registro de Humor</li>
              <li className="flex items-center gap-3 text-muted-foreground/50"><X size={20} className="flex-shrink-0" /> Sem mentoria de IA</li>
              <li className="flex items-center gap-3 text-muted-foreground/50"><X size={20} className="flex-shrink-0" /> Sem certificados</li>
            </ul>

            <button
              onClick={() => navigate('/dashboard')}
              className="w-full py-4 rounded-xl font-bold bg-foreground/5 hover:bg-foreground/10 transition-all text-foreground border border-border"
            >
              Continuar Grátis
            </button>
          </div>

          <div className="relative bg-surface/80 backdrop-blur-xl border border-primary/50 p-8 rounded-[2rem] flex flex-col shadow-[0_0_60px_rgba(79,70,229,0.15)] transform md:-translate-y-6 z-10">
            ...
            <div className="mb-8 pt-4">
              ...
              <p className="text-primary/80">Evolução sem limites</p>
              <div className="mt-6 flex items-baseline gap-1">
                <span className="text-5xl font-bold text-foreground">R$ 19,90</span>
                <span className="text-muted-foreground text-xl">/mês</span>
              </div>
            </div>
            ...
            <ul className="space-y-5 mb-10 flex-1">
              {[
                ...
                <li key={idx} className="flex items-center gap-3 text-foreground font-medium group">
            ...
            <p className="text-center text-xs text-muted-foreground mt-4">7 dias grátis, cancele quando quiser.</p>
          </div>
