    ...
    <div className="min-h-screen pb-20 pt-10 px-4 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full flex flex-col items-center">
        ...
        <div className="text-center space-y-8 mb-24 max-w-4xl">
          <div className="inline-flex items-center justify-center p-4 bg-surface/50 backdrop-blur-sm rounded-full border border-border shadow-xl mb-4 animate-in zoom-in duration-500">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            O <strong className="text-foreground">AuraQuest</strong> é uma plataforma inovadora que une a evolução técnica (Upskilling) com o cuidado mental. Transformamos sua jornada profissional em uma experiência gamificada única.
          </p>
        </div>
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-surface/40 backdrop-blur-md border border-border p-8 md:p-16 rounded-[2.5rem] shadow-2xl">
          <div className="space-y-8">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-yellow-500/10 rounded-xl">
                <Lightbulb className="text-yellow-400" size={28} />
              </div>
              <h3 className="text-3xl font-bold text-foreground">Nosso Propósito</h3>
            </div>

            <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
              <p>
                Em um cenário corporativo acelerado, o <span className="text-foreground font-semibold">burnout</span> e a <span className="text-foreground font-semibold">estagnação profissional</span> são riscos reais.
              </p>
              <p>
          ...
          <div className="relative h-[400px] rounded-3xl overflow-hidden border border-border bg-gradient-to-br from-background to-surface flex items-center justify-center group">
            ...
            <div className="relative z-10 text-center space-y-4 p-8 bg-surface/30 backdrop-blur-sm rounded-2xl border border-border">
              <Sparkles className="mx-auto text-yellow-400 mb-2" size={32} />
              <h4 className="text-2xl font-bold text-foreground">Tecnologia & Saúde</h4>
              <div className="h-px w-16 bg-primary mx-auto"></div>
              <p className="text-muted-foreground font-mono text-sm">FIAP © 2025</p>
            </div>
          </div>
        </div>
...
function CardPilar({ icon, titulo, descricao, delay }: { icon: React.ReactNode, titulo: string, descricao: string, delay: string }) {
  return (
    <div className={`bg-surface/60 backdrop-blur-sm border border-border p-8 rounded-3xl hover:border-primary/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group animate-in fade-in slide-in-from-bottom-4 fill-mode-backwards ${delay}`}>
      <div className="w-16 h-16 bg-black/30 rounded-2xl flex items-center justify-center mb-6 shadow-inner border border-border group-hover:scale-110 transition-transform duration-300">
        {icon}
      </div>
